    ...
    def save_model(self, request, obj, form, change):
        ...
        if obj.slot:  # 检查是否有关联的Slot
            ...
            try:
                ...
                utterance_ask = Utterance.objects.create(name=utter_ask_name, example=question, bot_id=bot_id)
            ...
            try:
                ...
                utterance_valid = Utterance.objects.create(name=utter_valid_name, example=valid, bot_id=bot_id)
            ...
            try:
                ...
                utterance_invalid = Utterance.objects.create(name=utter_invalid_name, example=invalid, bot_id=bot_id)
