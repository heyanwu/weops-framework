...
GH_MINIO_ACCESS_KEY = os.environ.get("BKAPP_GH_MINIO_ACCESS_KEY", "weops")
GH_MINIO_ENDPOINT = os.environ.get("BKAPP_GH_MINIO_ENDPOINT", "10.10.26.236:9015")
GH_MINIO_SECRET_KEY = os.environ.get("BKAPP_GH_MINIO_SECRET_KEY", "CwWeOps2022")
GH_MINIO_USE_HTTPS = os.environ.get("BKAPP_GH_MINIO_USE_HTTPS", "False")
